...
# url = 'http://www.glidedsky.com/level/crawler-basic-1'
# one = 'http://www.glidedsky.com/level/web/crawler-basic-1'
# header = {
#     "User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome"
# }
#
# response = requests.get(one, headers=header)
# print(response.text)
header = {
...
with open('text1.csv', 'a', encoding='utf-8') as f:
    f.write(data)
